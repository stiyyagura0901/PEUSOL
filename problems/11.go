...
`
	...
	parseGrid20x20 := func(g string) (grid [][]int64) {
		lines := strings.Split(g, "/n")
	...
	printMaxProductInfo := func(m int64, i, j int, a, b, c, d int64, dir string) {
		fmt.Println(m)
		fmt.Println(i, j)
	...
	findGreatestProduct := func(grid [][]int64) {
		var max int64
		var maxi, maxj int
